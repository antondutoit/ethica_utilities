...
```{r Frontmatter instructions and notes}
...
# Function to create column with count of NAs  # redundant - can use a fun from naniar:: - replace 
...
i <- i + 1
# survey_number <- 0
# Extract survey number from Ethica using regex; this expression will extract 3- to 5-digit survey numbers.
...
```{r export to CSV if required}
# KEEP THIS CODE CHUNK LAST IN THE SCRIPT! 
# un-comment and add file path if a CSV file is required
