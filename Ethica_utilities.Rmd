...
```{r To do}
# [IP] Function to join data frames into one 
# [IP] Clarify survey and activity numbers with Amin or Mohammad and alter naming conventions accordingly 
# use repeated() in line 82f. 
# add activity or survey numbers at the start of column names 
...
survey_numbers[i] <- str_extract(file_name, pattern = "_" %R% repeated(DGT, 5, 6) %R% "_")
...
question_numbers <- str_c("q", raw_question_numbers, "_", question_type, maq_option_no, sep = "")  
  }
